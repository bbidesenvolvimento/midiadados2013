...
use Bbi\TmanagerBundle\Form\CategoriaType;
...
class CategoriaController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('BbiTmanagerBundle:Categoria')->findAll();
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('BbiTmanagerBundle:Categoria')->find($id);
     ...
     * @Method("POST")
     * @Template("BbiTmanagerBundle:Categoria:new.html.twig")
     */
     ...
     * @Method("POST")
     * @Template("BbiTmanagerBundle:Categoria:edit.html.twig")
     */
