...
/* BbiTmanagerBundle:Item:edit.html.twig */
class __TwigTemplate_90d927a6a240cabd58d2933062c76790 extends Twig_Template
{
...
<form action=\"";
        // line 3
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("item_update", array("id" => $this->getAttribute($this->getContext($context, "entity"), "id"))), "html", null, true);
        echo "\" method=\"post\" ";
...
";
    ...
    {
        return "BbiTmanagerBundle:Item:edit.html.twig";
    }
