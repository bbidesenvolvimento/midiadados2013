...
class __TwigTemplate_9bb6087b2670ef1383bedbbf7832c769 extends Twig_Template
{
    ...
    {
        // line 3
        $context["__internal_89bee1973adde3e61cf39484e832cbad64a1a7ab"] = $this;
        // line 5
...
";
    ...
    ";
        // line 82
        echo $context["__internal_89bee1973adde3e61cf39484e832cbad64a1a7ab"]->getdisplay_timeline(("timeline_" . $this->getContext($context, "token")), $this->getAttribute($this->getContext($context, "collector"), "events"), $this->getContext($context, "colors"));
        echo "
    ...
    ";
        ...
        if (twig_length_filter($this->env, $this->getAttribute($this->getContext($context, "profile"), "children"))) {
            ...
            ";
                // line 92
                echo $context["__internal_89bee1973adde3e61cf39484e832cbad64a1a7ab"]->getdisplay_timeline(("timeline_" . $this->getAttribute($this->getContext($context, "child"), "token")), $this->getContext($context, "events"), $this->getContext($context, "colors"));
                echo "
        ";
            }
...
";
        // line 393
        echo $context["__internal_89bee1973adde3e61cf39484e832cbad64a1a7ab"]->getdump_request_data($this->getContext($context, "token"), $this->getContext($context, "profile"), $this->getAttribute($this->getContext($context, "collector"), "events"), $this->getAttribute($this->getAttribute($this->getAttribute($this->getContext($context, "collector"), "events"), "__section__"), "origin"));
        echo "
...
";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["child"]) {
                // line 398
                echo $context["__internal_89bee1973adde3e61cf39484e832cbad64a1a7ab"]->getdump_request_data($this->getAttribute($this->getContext($context, "child"), "token"), $this->getContext($context, "child"), $this->getAttribute($this->getAttribute($this->getContext($context, "child"), "getcollector", array(0 => "time"), "method"), "events"), $this->getAttribute($this->getAttribute($this->getAttribute($this->getContext($context, "collector"), "events"), "__section__"), "origin"));
...
";
    ...
    public function getdump_request_data($_token = null, $_profile = null, $_events = null, $_origin = null)
    {
        ...
        try {
            // line 432
            $context["__internal_4b42b948acc902a9658893a5da637b9be20cde40"] = $this;
            // line 433
            echo "                {
                    \"id\": \"";
            // line 434
...
";
            // line 437
            echo $context["__internal_4b42b948acc902a9658893a5da637b9be20cde40"]->getdump_events($this->getContext($context, "events"));
            echo "
                    ]
                }
";
